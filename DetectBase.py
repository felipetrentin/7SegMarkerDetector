...
def main():
        ...
        image = cv2.imread("Exemplos/Screenshot2.png")
        image = imutils.resize(image, height = 1000)
        ratio = image.shape[0] / 1000.0
        orig = image.copy()
        mask = cv2.inRange(image, black[0], black[1])
        ...
        plt.subplot(121),plt.imshow(warped, cmap = 'plasma')
        plt.subplot(122),plt.imshow(binary_nums, cmap = 'plasma')
        print(np.array([[binary_nums[19][46], binary_nums[35][62], binary_nums[70][67], binary_nums[86][48], binary_nums[70][30], binary_nums[40][36], binary_nums[52][47]]]))
        print(np.array([[binary_nums[20][100], binary_nums[32][121], binary_nums[71][117], binary_nums[85][100], binary_nums[70][85], binary_nums[36][84], binary_nums[20][100]]]))
        plt.show()
        #print(binary_nums)
